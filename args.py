...
parser.add_argument('--train_file', default='./dataset/res_15/res15_train_5_ac_debis.pkl', help='Provide path to pickle file with training data. Refer to README for format.') #INSted_permuted_train_CNN.pkl
parser.add_argument('--dev_file', default='./dataset/res_15/res15_dev_5_ac_debis.pkl',  help='Provide path to pickle file with development data. Refer to README for format.') #INSteD_permuted_dev_CNN.pkl
parser.add_argument('--test_file', default='./dataset/res_15/res15_test_5_ac_debis.pkl', help='Provide path to pickle file with test data. Refer to README for format.')
# parser.add_argument('--train_file', default='./dataset/res_15/rest15_train_5.pkl', help='Provide path to pickle file with test data. Refer to README for format.')
# parser.add_argument('--test_file', default='./dataset/res_15/rest15_test_5.pkl', help='Provide path to pickle file with test data. Refer to README for format.')
# parser.add_argument('--dev_file', default='./dataset/res_15/rest15_test_5.pkl', help='Provide path to pickle file with test data. Refer to README for format.')

# parser = argparse.ArgumentParser(description='Parameters for Training/Testing/Evaluating with the Generalizable Coherence Model')
# parser.add_argument('--train_file', default='./dataset/laptop_15/laptop15_train_5.pkl', help='Provide path to pickle file with training data. Refer to README for format.') #INSted_permuted_train_CNN.pkl
# parser.add_argument('--dev_file', default='./dataset/laptop_15/laptop15_dev_5.pkl',  help='Provide path to pickle file with development data. Refer to README for format.') #INSteD_permuted_dev_CNN.pkl
# parser.add_argument('--test_file', default='./dataset/laptop_15/laptop15_test_pair=5_absa.pkl', help='Provide path to pickle file with test data. Refer to README for format.')
# parser.add_argument('--train_file', default='./dataset/res_15/res15_train_5.pkl', help='Provide path to pickle file with training data. Refer to README for format.') #INSted_permuted_train_CNN.pkl
# parser.add_argument('--dev_file', default='./dataset/res_15/res15_dev_5.pkl',  help='Provide path to pickle file with development data. Refer to README for format.') #INSteD_permuted_dev_CNN.pkl
# parser.add_argument('--test_file', default='./dataset/res_15/rest15_test_pair=5_absa.pkl', help='Provide path to pickle file with test data. Refer to README for format.')
...
parser.add_argument('--lr_start', type=float, default=7e-06, help='Starting learning rate')
...
parser.add_argument('--polarities_dim', type=int, default=6, help='Starting learning rate')
parser.add_argument('--dropout_rate' , default=0.1, type=float,
                    help='specify the dropout rate for all layer, also applies to all transformer layers.')
parser.add_argument('--alpha', default=0.840414171966546, type=float,
                    help='specify the dropout rate for all layer, also applies to all transformer layers.')
